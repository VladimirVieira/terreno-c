1.        O que foi feito (o básico e as funcionalidades extras implementadas):
...
Ao longo do desenvolvimento do projeto, percebi a necessidade de variação do tamanho da imagem, pois o usuário pode escolher um fator de deslocamento que gera algum valor aleatório que fica fora da quantidade de linhas da matriz, pois esta tem uma quantidade de linhas fixas.
